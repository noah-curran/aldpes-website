(function (global, factory) {
	...
	(factory((global['ngx-image-gallery'] = {}),global.core,global.common,global.lodash));
}(this, (function (exports,core,common,lodash) { 'use strict';
...
var NgxImageGalleryComponent = (function () {
    ...
    Object.defineProperty(NgxImageGalleryComponent.prototype, "thumbnailsRenderParams", {
         ...
         */
        get: function () {
            var /** @type {?} */ thumbnailsContainerWidth = this.thumbnailsElem.nativeElement.offsetWidth;
            var /** @type {?} */ thumbnailMargin = 16;
            var /** @type {?} */ thumbnailSize = thumbnailMargin + this.conf.thumbnailSize;
            var /** @type {?} */ thumbnailsInView = Math.floor(thumbnailsContainerWidth / thumbnailSize);
            var /** @type {?} */ extraSpaceInThumbnailsContainer = thumbnailsContainerWidth - (thumbnailsInView * thumbnailSize);
            var /** @type {?} */ extraMargin = extraSpaceInThumbnailsContainer / thumbnailsInView;
            var /** @type {?} */ newThumbnailMargin = thumbnailMargin + extraMargin;
            var /** @type {?} */ newThumbnailSize = newThumbnailMargin + this.conf.thumbnailSize;
            var /** @type {?} */ relativePositionOfActiveImageThumbnailToScroller = thumbnailsInView - (thumbnailsInView - this.activeImageIndex);
            var /** @type {?} */ thumbnailsScrollerLeftMargin;
            if (relativePositionOfActiveImageThumbnailToScroller > thumbnailsInView - 2) {
                var /** @type {?} */ outThumbnails = ((this.activeImageIndex + 1) - thumbnailsInView) + 1;
    ...
    NgxImageGalleryComponent.prototype.loadImage = function (index) {
        var _this = this;
        var /** @type {?} */ galleryImage = this.images[index];
    ...
    NgxImageGalleryComponent.prototype.scrollThumbnails = function () {
        ...
        if (this.conf.showThumbnails == false)
            return false;
        var /** @type {?} */ thumbnailParams = this.thumbnailsRenderParams;
...
var ClickOutsideDirective = (function () {
    ...
    ClickOutsideDirective.prototype.onClick = function ($event, targetElement) {
        var /** @type {?} */ isClickedInside = this._elementRef.nativeElement.contains(targetElement);
        if (!isClickedInside) {
 ...
 * @nocollapse
 */
NgxImageGalleryModule.ctorParameters = function () { return []; };
